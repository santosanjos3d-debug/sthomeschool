...
const translations = {
  pt: {
    ...
    'professors.giorgio.cred3': 'Formação acadêmica em pesquisa científica de alto nivel',
    ...
    'about.origin3': 'Hoje, a ST Homeschool e referência em educação científica personalizada, atendendo familias que buscam excelência acadêmica aliada a valores solidos e acompanhamento individual.',
