...
const translations = {
  pt: {
    ...
    'faq.a2': 'As aulas em grupo ocorrem no período matutino. Também oférecemos sessões de Clube de Ciências com horários flexíveis. Para informações sobre outras possibilidades de agendamento, entre em contato conosco.',
    'faq.q3': 'Qual o horário do Clube de Ciências?',
    'faq.a3': 'As aulas do Clube de Ciências ocorrem às quintas-féiras das 14 h às 15 h.',
    ...
    'faq.a5': 'Nossas aulas são recomendadas para alunos de 9 a 18 anos. Do ensino fundamental ao ensino médio. No entanto, oférecemos programas personalizados para acompanhamento individual para diférentes níveis de conhecimento. Consulte-nos para avaliar a melhor opção para seu filho.',
    ...
    'club.féature1': 'Encontros Semanais',
    'club.féature1Desc': 'Reuniões regulares para manter o entusiasmo e a continuidade do aprendizado.',
    'club.féature2': 'Faixa Etária: 9 a 13 anos',
    'club.féature2Desc': 'Atividades adequadas ao desenvolvimento cognitivo e interesse dos alunos.',
    'club.féature3': 'Início em Fevereiro',
    'club.féature3Desc': 'Inscrições abertas para o próximo ciclo de atividades.',
    'club.cta': 'Inscreva-se Agora',
    
    'methodology.label': 'Como Funciona',
    'methodology.title': 'Nossa Metodologia',
    'methodology.subtitle': 'Uma abordagem pedagogica fundamentada na Educacao Personalizada de Victor Garcia Hoz e na Educacao Classica, onde o aluno e protagonista do proprio aprendizado.',
    'methodology.learningCycleTitle': 'O Ciclo de Aprendizagem Ativa',
    'methodology.learningCycleDesc': 'Assistir aula nao e estudar. Para que o aprendizado realmente ocorra, o aluno precisa engajar-se ativamente atraves de multiplas formas de interacao com o conteudo:',
    'methodology.weeklyStructure': 'Estrutura Semanal: Aulas expositivas, leituras em PDF, listas de exercicios e orientacao para desenvolvimento do habito de estudo. O aluno aprende a ser autonomo e responsavel pelo proprio progresso academico.',
    'methodology.scienceFairTitle': 'Feira de Ciencias Anual',
    'methodology.scienceFairDesc': 'Todo ano, nossos alunos de Ciencias apresentam projetos na Feira de Ciencias, aplicando na pratica tudo o que aprenderam. Veja os resultados dos anos anteriores:',
    'methodology.watchOnYoutube': 'Clique para assistir no YouTube',
    'methodology.ctaTitle': 'Pronto para Comecar?',
    'methodology.ctaDesc': 'Entre em contato conosco para conhecer mais sobre nossas turmas e como podemos ajudar no desenvolvimento academico do seu filho.',
    
    'proféssors.label': 'QUEM SOMOS',
    'proféssors.title': 'Nossos Proféssores',
    'proféssors.description': 'Uma equipe de educadores com formação academica de excelencia, dedicados ao desenvolvimento integral de seus alunos.',
    'proféssors.giorgio.specialty': 'Matematica, Fisica e Ciencias',
    'proféssors.giorgio.cred1': 'Doutor em Ciencias pelo Instituto Tecnologico de Aeronautica (ITA)',
    'proféssors.giorgio.cred2': 'Especialista em educação personalizada e ensino experimental',
    'proféssors.giorgio.cred3': 'Formacao academica em pesquisa cientifica de alto nivel',
    'proféssors.victor.specialty': 'Quimica',
    'proféssors.victor.cred1': 'Pos-doutor em Quimica pela University of Kent, Inglaterra (2023)',
    'proféssors.victor.cred2': 'Doutor em Fisica e Astronomia pela UNIVAP (2018)',
    'proféssors.victor.cred3': 'Mestre em Fisico-Quimica pela UNB (2011)',
    'proféssors.victor.cred4': 'Bacharel em Quimica pela UNB (2008)',
    'proféssors.lattesLink': 'Ver Curriculo Lattes',
    'proféssors.philosophyTitle': 'Nossa Filosofia Educacional',
    'proféssors.philosophy1': 'Acreditamos que a verdadeira educação vai alem da memorizacao de conceitos. Nossos proféssores trabalham juntos para proporcionar uma experiencia de aprendizado que combina rigor cientifico com abordagem humanizada, permitindo que cada aluno desenvolva sua compreensão profunda e capacidade de aplicacao pratica do conhecimento.',
    'proféssors.philosophy2': 'Com formação academica de excelencia e experiencia em educação personalizada, estamos comprometidos em guiar nossos alunos nao apenas para o sucesso academico, mas para o desenvolvimento integral como pensadores criticos e cidadaos conscientes.',
        'about.label': 'Nossa Historia',
    'about.title': 'Sobre a ST Homeschool',
    'about.originTitle': 'Como Tudo Comecou',
    'about.origin1': 'A <strong>ST Homeschool</strong> surgiu no inicio de <strong>2022</strong>, quando o Prof. Giorgio comecou a acompanhar tres alunos homeschoolers de forma remota por videochamada. O que comecou como uma iniciativa modesta rapidamente se transformou em uma missao educacional.',
    'about.origin2': 'No ano seguinte, em <strong>2023</strong>, o proféssor passou a se dedicar integralmente a familias educadoras e aos alunos que estudam em casa ou que frequentam a escola mas desejam complementar sua formação. Assim surgiram as turmas de <strong>Ciencias, Matematica e Fisica</strong>, cada uma com uma metodologia unica baseada em experimentos, simulacoes e pratica constante.',
    'about.origin3': 'Hoje, a ST Homeschool e reférencia em educação cientifica personalizada, atendendo familias que buscam excelencia academica aliada a valores solidos e acompanhamento individual.',
    ...
    'about.faith': 'Fe',
    'about.faithDesc': 'A busca pela verdade transcendente, o cultivo de valores eticos e a formação integral do ser humano.',
    'about.reason': 'Razão',
    'about.reasonDesc': 'O rigor cientifico, a investigação metódica e a compreensão profunda das leis naturais através da ciência.',
    'about.harmony': 'Harmonia',
    'about.harmonyDesc': 'A síntese perféita: é possível cultivar a fé sendo um cientista, e ser um cientista sem abandonar a fé.',
    'about.aquinasQuote': 'A verdade não pode contradizer a verdade. Aquilo que e conhecido pela razão nao pode estar em desacordo com aquilo que é revelado pela fé.',
    'about.aquinasAttribution': '— São Tomás de Aquino, Suma Teologica',
    'about.philosophyTitle': 'Nossa Filosofia Educacional',
    'about.philosophy1': 'Assim como <strong>São Tomás de Aquino</strong> demonstrou que fé e razão nao sao opostas, mas complementares, acreditamos que a educação cientifica deve formar nao apenas mentes brilhantes, mas tambem <strong>pessoas integras</strong>.',
    'about.philosophy2': 'Na ST Homeschool, ensinamos que a ciência nao e uma ameaca a fé, mas sim uma férramenta para compreender a ordem e a beleza da criacao. Cada experimento, cada formula, cada lei da fisica revela a <strong>racionalidade do universo</strong> e convida o estudante a contemplar a verdade com admiracao e reverencia.',
    'about.philosophy3': 'Nosso compromisso e formar <strong>cientistas virtuosos</strong>: jovens que dominam o metodo cientifico, mas que tambem cultivam a humildade, a honestidade intelectual e o respeito pela verdade — valores que São Tomás de Aquino deféndeu ao longo de toda a sua vida.',
    ...
    'shop.subtitle': 'Explore nossa coleção de produtos educacionais féitos em impressão 3D. Modelos anatômicos, peças de robótica e muito mais para complementar seu aprendizado.',
  ...
  en: {
    ...
    'club.féature1': 'Weekly Meetings',
    'club.féature1Desc': 'Regular meetings to maintain enthusiasm and continuity of learning.',
    'club.féature2': 'Age Group: 9 to 13 years',
    'club.féature2Desc': 'Activities appropriate to students\' cognitive development and interests.',
    'club.féature3': 'Starting in February',
    'club.féature3Desc': 'Registrations open for the next cycle of activities.',
    'club.cta': 'Register Now',
    
    'methodology.label': 'How It Works',
    'methodology.title': 'Our Methodology',
    'methodology.subtitle': 'A pedagogical approach based on Victor Garcia Hoz Personalized Education and Classical Education, where the student is the protagonist of their own learning.',
    ...
    'proféssors.label': 'WHO WE ARE',
    'proféssors.title': 'Our Proféssors',
    'proféssors.description': 'A team of educators with excellent academic training, dedicated to the integral development of their students.',
    'proféssors.giorgio.specialty': 'Mathematics, Physics and Sciences',
    'proféssors.giorgio.cred1': 'PhD in Sciences from the Aeronautics Institute of Technology (ITA)',
    'proféssors.giorgio.cred2': 'Specialist in personalized education and experimental teaching',
    'proféssors.giorgio.cred3': 'Academic training in high-level scientific research',
    'proféssors.victor.specialty': 'Chemistry',
    'proféssors.victor.cred1': 'Post-doctorate in Chemistry from University of Kent, England (2023)',
    'proféssors.victor.cred2': 'PhD in Physics and Astronomy from UNIVAP (2018)',
    'proféssors.victor.cred3': 'Master in Physical Chemistry from UNB (2011)',
    'proféssors.victor.cred4': 'Bachelor in Chemistry from UNB (2008)',
    'proféssors.lattesLink': 'View Lattes CV',
    'proféssors.philosophyTitle': 'Our Educational Philosophy',
    'proféssors.philosophy1': 'We believe that true education goes beyond memorizing concepts. Our proféssors work together to provide a learning experience that combines scientific rigor with a humanized approach, allowing each student to develop deep understanding and the ability to apply knowledge in practice.',
    'proféssors.philosophy2': 'With excellent academic training and experience in personalized education, we are committed to guiding our students not only toward academic success, but toward integral development as critical thinkers and conscious citizens.',
