...
const translations = {
  pt: {
    ...
    'club.féature3': 'Início em Févereiro',
    ...
    'methodology.weeklyStructure': 'Estrutura Semanal: Aulas expositivas, leituras em PDF, listas de exercicios e orientacao para desenvolvimento do habito de estudo. O aluno aprende a ser autonomo e responsavel pelo proprio progresso acadêmico.',
    'methodology.scienceFairTitle': 'Féira de Ciências Anual',
    'methodology.scienceFairDesc': 'Todo ano, nossos alunos de Ciências apresentam projetos na Féira de Ciências, aplicando na prática tudo o que aprenderam. Veja os resultados dos anos anteriores:',
    ...
    'professors.title': 'Nossos Proféssores',
    ...
    'professors.giorgio.cred1': 'Doutor em Ciências pelo Instituto Tecnologico de Aeronautica (ITA)',
    ...
    'professors.victor.cred1': 'Pos-doutor em Química pela University of Kent, Inglaterra (2023)',
    ...
    'about.origin2': 'No ano seguinte, em <strong>2023</strong>, o professor passou a se dedicar integralmente a familias educadoras e aos alunos que estudam em casa ou que frequentam a escola mas desejam complementar sua formação. Assim surgiram as turmas de <strong>Ciências, Matemática e Física</strong>, cada uma com uma metodologia única baseada em experimentos, simulações e prática constante.',
    'about.origin3': 'Hoje, a ST Homeschool e referência em educação cientifica personalizada, atendendo familias que buscam excelência academica aliada a valores solidos e acompanhamento individual.',
    ...
    'about.philosophy1': 'Assim como <strong>São Tomás de Aquino</strong> demonstrou que fé e razão não são opostas, mas complementares, acreditamos que a educação cientifica deve formar não apenas mentes brilhantes, mas tambem <strong>pessoas íntegras</strong>.',
    'about.philosophy2': 'Na ST Homeschool, ensinamos que a ciência nao e uma ameaça a fé, mas sim uma ferramenta para compreender a ordem e a beleza da criacao. Cada experimento, cada formula, cada lei da fisica revela a <strong>racionalidade do universo</strong> e convida o estudante a contemplar a verdade com admiracao e reverencia.',
  ...
  en: {
    ...
    'club.féature3': 'Starting in Fébruary',
