...
const faqItemsData: FAQItemData[] = [
  ...
  },
  {
    ...
    answerPt: 'As aulas em grupo ocorrem no período matutino. Também oferecemos sessões de Clube de Ciências com horários flexíveis. Para informações sobre outras possibilidades de agendamento, entre em contato conosco.',
  ...
  },
  {
    ...
    answerPt: 'Você pode entrar em contato conosco via WhatsApp, email ou preenchendo o formulário de pré-inscrição. Responderemos suas dúvidas o mais breve possível. Também oferecemos uma conversa inicial gratuita para discutir suas expectativas e necessidades.',
    answerEn: 'You can contact us via WhatsApp, email or by filling out the pre-registration form. We will answer your questions as soon as possible. We also offer a free initial conversation to discuss your expectations and needs.'
  }
];
