...
const translations = {
  pt: {
    ...
    'faq.a5': 'Nossas aulas são recomendadas para alunos de 9 a 18 anos. Do ensino fundamental ao ensino médio. No entanto, oferecemos programas personalizados para acompanhamento individual para diferentes níveis de conhecimento. Consulte-nos para avaliar a melhor opção para seu filho.',
    'faq.q6': 'Existe desconto para famílias de baixa renda?',
    'faq.a6': 'Sim. Oferecemos condições especiais (bolsa/desconto) para famílias de baixa renda, mediante análise. Entre em contato pelo WhatsApp para solicitar a avaliação e verificar a disponibilidade e o percentual de desconto aplicável.',
    
    'courses.label': 'Programas Educacionais',
    'courses.title': 'Turmas 2026',
    'courses.subtitle': 'Cursos estruturados para diferentes faixas etárias, com turmas divididas por conteúdo e nível de desenvolvimento.',
    ...
    'professors.description': 'Uma equipe de educadores com formacao academica de excelencia, dedicados ao desenvolvimento integral de seus alunos.',
    'professors.giorgio.specialty': 'Matematica, Fisica e Ciencias',
    'professors.giorgio.cred1': 'Doutor em Ciencias pelo Instituto Tecnologico de Aeronautica (ITA)',
    'professors.giorgio.cred2': 'Especialista em educacao personalizada e ensino experimental',
    'professors.giorgio.cred3': 'Formacao academica em pesquisa cientifica de alto nivel',
    'professors.victor.specialty': 'Quimica',
    'professors.victor.cred1': 'Pos-doutor em Quimica pela University of Kent, Inglaterra (2023)',
    'professors.victor.cred2': 'Doutor em Fisica e Astronomia pela UNIVAP (2018)',
    'professors.victor.cred3': 'Mestre em Fisico-Quimica pela UNB (2011)',
    'professors.victor.cred4': 'Bacharel em Quimica pela UNB (2008)',
    'professors.lattesLink': 'Ver Curriculo Lattes',
    'professors.philosophyTitle': 'Nossa Filosofia Educacional',
    'professors.philosophy1': 'Acreditamos que a verdadeira educacao vai alem da memorizacao de conceitos. Nossos professores trabalham juntos para proporcionar uma experiencia de aprendizado que combina rigor cientifico com abordagem humanizada, permitindo que cada aluno desenvolva sua compreensao profunda e capacidade de aplicacao pratica do conhecimento.',
    'professors.philosophy2': 'Com formacao academica de excelencia e experiencia em educacao personalizada, estamos comprometidos em guiar nossos alunos nao apenas para o sucesso academico, mas para o desenvolvimento integral como pensadores criticos e cidadaos conscientes.',
    ...
    'about.origin2': 'No ano seguinte, em <strong>2023</strong>, o professor passou a se dedicar integralmente a familias educadoras e aos alunos que estudam em casa ou que frequentam a escola mas desejam complementar sua formacao. Assim surgiram as turmas de <strong>Ciencias, Matematica e Fisica</strong>, cada uma com uma metodologia unica baseada em experimentos, simulacoes e pratica constante.',
    'about.origin3': 'Hoje, a ST Homeschool e referencia em educacao cientifica personalizada, atendendo familias que buscam excelencia academica aliada a valores solidos e acompanhamento individual.',
    'about.whySaintThomasTitle': 'Por que Saint Thomas?',
    'about.whySaintThomasDesc': 'Nosso nome se inspira em <strong>Sao Tomas de Aquino</strong>, o Doutor Angelico, que soube conciliar tao bem dois pilares fundamentais do conhecimento humano: <strong>fe e razao</strong>.',
    'about.faith': 'Fe',
    'about.faithDesc': 'A busca pela verdade transcendente, o cultivo de valores eticos e a formacao integral do ser humano.',
    'about.reason': 'Razao',
    'about.reasonDesc': 'O rigor cientifico, a investigacao metodica e a compreensao profunda das leis naturais atraves da ciencia.',
    'about.harmony': 'Harmonia',
    'about.harmonyDesc': 'A sintese perfeita: e possivel cultivar a fe sendo um cientista, e ser um cientista sem abandonar a fe.',
    'about.aquinasQuote': 'A verdade nao pode contradizer a verdade. Aquilo que e conhecido pela razao nao pode estar em desacordo com aquilo que e revelado pela fe.',
    'about.aquinasAttribution': '— Sao Tomas de Aquino, Suma Teologica',
    'about.philosophyTitle': 'Nossa Filosofia Educacional',
    'about.philosophy1': 'Assim como <strong>Sao Tomas de Aquino</strong> demonstrou que fe e razao nao sao opostas, mas complementares, acreditamos que a educacao cientifica deve formar nao apenas mentes brilhantes, mas tambem <strong>pessoas integras</strong>.',
    'about.philosophy2': 'Na ST Homeschool, ensinamos que a ciencia nao e uma ameaca a fe, mas sim uma ferramenta para compreender a ordem e a beleza da criacao. Cada experimento, cada formula, cada lei da fisica revela a <strong>racionalidade do universo</strong> e convida o estudante a contemplar a verdade com admiracao e reverencia.',
    'about.philosophy3': 'Nosso compromisso e formar <strong>cientistas virtuosos</strong>: jovens que dominam o metodo cientifico, mas que tambem cultivam a humildade, a honestidade intelectual e o respeito pela verdade — valores que Sao Tomas de Aquino defendeu ao longo de toda a sua vida.',
  ...
  en: {
    ...
    'faq.q1': 'What are the class fees?',
    ...
    'faq.a2': 'Group classes are held in the morning. We also offer Science Club sessions with flexible schedules. For information about other scheduling options, please contact us.',
    ...
    'faq.a5': 'Our classes are recommended for students aged 9 to 18. From elementary to high school. However, we offer personalized programs for individual mentoring for different knowledge levels. Consult us to evaluate the best option for your child.',
    'faq.q6': 'Is there a discount for low-income families?',
    'faq.a6': 'Yes. We offer special conditions (scholarship/discount) for low-income families, subject to analysis. Contact us via WhatsApp to request the evaluation and check the availability and discount percentage applicable.',
    
    'courses.label': 'Educational Programs',
    'courses.title': 'Classes 2026',
    'courses.subtitle': 'Structured courses for different age groups, with classes divided by content and development level.',
    ...
    'club.feature3': 'Starting in February',
    ...
    'professors.title': 'Our Professors',
    ...
    'about.origin3': 'Today, ST Homeschool is a reference in personalized scientific education, serving families seeking academic excellence combined with solid values and individual mentoring.',
    ...
    'about.harmonyDesc': 'The perfect synthesis: it is possible to cultivate faith while being a scientist, and to be a scientist without abandoning faith.',
    ...
    'about.philosophy3': 'Our commitment is to form <strong>virtuous scientists</strong>: young people who master the scientific method, but who also cultivate humility, intellectual honesty, and respect for truth — values that Saint Thomas Aquinas championed throughout his life.',
    ...
    'shop.qualityMaterialsDesc': 'Professional 3D printing with refined finish and guaranteed durability.',
